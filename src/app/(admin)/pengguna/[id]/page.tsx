...
import { User, Mail, ShieldCheck, CalendarDays, Hash, ArrowLeft } from 'lucide-react';
...
export default async function UserDetailPage({ params }: UserDetailPageProps) {
    ...
    return (
        // Menggunakan space-y untuk jarak antar elemen utama
        <div className="space-y-6">
            {/* 1. Menambahkan tombol "Kembali" untuk navigasi yang lebih baik */}
            <Link 
                href="/pengguna" // Asumsi daftar pengguna ada di path ini
            ...
            {/* 2. Menggunakan style panel/kartu yang konsisten */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                {/* 3. Layout Grid untuk detail yang lebih rapi dan informatif */}
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            {/* 4. Menggunakan kembali style "Badge" yang konsisten */}
                            <span className={`px-2.5 py-1 text-sm font-medium rounded-full capitalize ${
                                user.role === 'admin' 
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Tanggal Bergabung</p>
                    ...
                    <div className="flex items-start space-x-3 md:col-span-2">
                        ...
                        <div>
                            ...
                            <p className="text-base font-mono text-gray-700 dark:text-gray-200">{user.id}</p>
                        </div>
                    </div>
                </div>
            </div>
