...
export const OurStorySection = () => {
  return (
    <section
      id="story"
      className="py-20 md:py-28 bg-[var(--nimo-gray)] relative"
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 text-center max-w-4xl relative">
        ...
        <p className="text-lg leading-relaxed mb-10 text-nimo-dark">
          ...
          food waste tidak hanya merusak planet, tetapi juga menyebabkan
          kerugian ekonomi yang besar. NOMI lahir sebagai jembatan antara
          penjual makanan berlebih dengan pembeli cerdas.
        </p>
