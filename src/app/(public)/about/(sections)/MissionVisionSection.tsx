...
export const MissionVisionSection = () => {
  return (
    <section
      id="mission-vision"
      className="py-20 md:py-28 bg-[var(--nimo-gray)]"
    >
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <div className="bg-white p-8 border border-black rounded-2xl shadow-md">
            <Target className="h-10 w-10 text-nimo-yellow mb-4" />
            <h3 className="text-3xl text-black font-bold mb-4">Visi Kami</h3>
            <p className="text-xl leading-relaxed italic text-black">
            ...
            <ul className="space-y-5">
              {missions.map((mission, index) => (
                <li key={index} className="flex items-start">
                  ...
                  <span className="text-text-nimo-light">{mission}</span>
                </li>
              ))}
            </ul>
          </div>
