...
const faqData = [
  ...
  // {
  //     question: "Apakah ada biaya untuk menjadi mitra NOMI?",
  ...
  // {
  //     question: "Apakah saya harus mengunduh aplikasi untuk menggunakan NOMI?",
  //     answer: "Ya, saat ini layanan NOMI tersedia melalui aplikasi mobile di Android & iOS untuk memudahkan pengalaman pengguna."
  // },
  // {
